 ...
 * assert what `0.156.0` actually does, so a version bump that changes it fails
...
describe("what foldkit 0.156.0 renders, and what it leaves out", () => {
